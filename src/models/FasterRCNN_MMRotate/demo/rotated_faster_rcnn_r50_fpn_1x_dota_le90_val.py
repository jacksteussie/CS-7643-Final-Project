...
data = dict(
    ...
    train=dict(
        type='DOTADataset',
        ann_file='/teamspace/studios/this_studio/mmrotate/data/DOTA1_5/train/annfiles_corr1p0/',
    ...
    val=dict(
        type='DOTADataset',
        ann_file='/teamspace/studios/this_studio/mmrotate/data/DOTA1_5/val/annfiles_corr1p0/',
...
lr_config = dict(warmup='linear',  # Gradually increase LR at the start
    warmup_iters=500,
    warmup_ratio=0.001,
    policy='CosineAnnealing',  # Smoothly decrease LR over time
    min_lr=1e-6
)
